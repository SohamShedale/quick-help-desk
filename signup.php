<?php
    ...
    if(isset($_POST['signup'])){
        ...
        if($rpassword1!=$rpassword2){
            ...
            $sql="SELECT r_email FROM resolver WHERE r_email='$remail'";
            $result=mysqli_query($conn,$sql);
    
            if(mysqli_num_rows($result)>0){
                echo '<div class="alert alert-danger">User Already Exists!</div>';
            }else{
                $sql="INSERT INTO resolver VALUES('$remail','$rpassword1')";
                $result=mysqli_query($conn,$sql);
                if($result){
                        ...
                        <div class="col-7">
                            ...
                            <div class="d-flex align-items-center  justify-content-center mb-3">
                             ...
                             <div class="form-floating  mb-3 ">
                                 <input type="email" name="r_id" class="form-control rounded bg-white text-dark " id="floatingInput" placeholder="name@example.com" required>
                             ...
                             <div class="form-floating   mb-4">
                                 <input type="password" name="confPass" class="form-control rounded bg-white text-dark" id="floatingPassword" placeholder="Password" required>
